...
type (literally the text): ``localhost`` in the server address, and join. (Or [IP](<https://whatismyipaddress.com/>) of player running the Forge Server with ``.apmc``)
...
> - PortForward [mod](<https://modrinth.com/mod/dedicatedmcupnp/versions?g=1.19.4&g=1.20.4&l=forge>) + [Architectury API](<https://modrinth.com/mod/architectury-api/versions?g=1.19.4&g=1.20.4&l=forge>) (or [e4mc](<https://modrinth.com/mod/e4mc/versions?g=1.19.4&g=1.20.4&l=forge>) & terminal address). Place in ``mods`` folder of Forge server. Or try [this](<https://gist.github.com/jacobmix/ed6a0dcf3188f4843e414099fdd63cc4>). 
